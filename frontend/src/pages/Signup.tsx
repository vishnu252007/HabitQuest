...
import { Mail, Lock, User, UserPlus, Gamepad2, AlertCircle, ArrowLeft, Eye, EyeOff } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await signup(form.email, form.username, form.password);
    if (success) {
      navigate('/dashboard');
    }
  };
      ...
      >
        ...
        <div className="text-center mb-6 space-y-2">
          ...
          <p className="text-slate-500 text-xs font-medium">
            Start building daily habits and unlocking achievements
          </p>
        </div>
